...
class GridScene extends phaser_1.Scene {
     ...
     */
    init(params) {
        new core_1.Grid(params.rows);
        this.mines = core_1.Grid.nMines;
        this.params = params;
    }
    /**
    ...
    create() {
        ...
        this.cellObjs = new Array(core_1.Grid.nRows).fill(undefined).map((_elem, index_i) => {
            return new Array(core_1.Grid.nRows).fill(undefined).map((_elem, index_j) => {
                const p0 = { x: (index_j * this.params.cellWidth) + this.params.cellWidth / 2, y: (index_i * this.params.cellWidth) + this.params.cellWidth / 2 };
                return this.add.existing(new CellObj_1.default(this, p0, { cellObj: core_1.Grid.getCell([index_i, index_j]) }));
            });
        }).flat();
        ...
        const handleGameOver = () => {
            ...
            core_1.Grid.uncoverRemainingMines();
